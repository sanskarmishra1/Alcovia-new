    ...
    <div class="offcanvas custom-offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1">
              ...
              <li class="nav-item">
                  <a class="nav-link out" href="<?php echo e(config('app.baseURL')); ?>/about">About Us</a>
                  <hr>
              </li>
                <li class="nav-item">
...
</html><?php /**PATH C:\xampp\htdocs\alcovia\resources\views/contact.blade.php ENDPATH**/ ?>